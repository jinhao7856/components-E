...
import ProductVariantExample_01 from "@/app/components/productVariants/Product_variants_01_ex";
import ProductVariantExample_02 from "@/app/components/productVariants/Product_variants_02_ex";
import ProductVariantExample_03 from "@/app/components/productVariants/Product_variants_03_ex";
import ProductVariantExample_04 from "@/app/components/productVariants/Product_variants_04_ex";
import ProductVariantExample_05 from "@/app/components/productVariants/Product_variants_05_ex";
import Head from "@/app/Head";

export default function Product_Variants() {
    ...
    const items1: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <ProductVariantExample_01/>,
        },
        {
            key: '2',
            label: '代码',
    ...
    const items2: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <ProductVariantExample_02/>,
        },
        {
            key: '2',
            label: '代码',
    ...
    const items3: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <ProductVariantExample_03/>,
        },
        {
            key: '2',
            label: '代码',
    ...
    const items4: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <ProductVariantExample_04/>,
        },
        {
            key: '2',
            label: '代码',
    ...
    const items5: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <ProductVariantExample_05/>,
        },
        {
            key: '2',
            label: '代码',
                ...
                <div className='relative row-start-1 grid grid-cols-subgrid lg:col-start-3'>
                    <div className='mx-auto grid w-full max-w-2xl grid-cols-1 gap-2 xl:max-w-7xl xl:grid-cols-[minmax(0,1fr)_var(--container-2xs)]'>
                        <div className='flex flex-1 flex-col gap-6 px-4 pt-8 pb-24 sm:px-6 xl:pr-0'>
                            ...
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>产品变体-01</h3>
                            ...
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>产品变体-02</h3>
                            <div className='relative z-0 flex items-center justify-between pb-4'>
                                <div className="relative min-h-screen w-full">
                                    <div className='focus-visible:ring-ring relative mt-2 rounded-md border border-zinc-200 ring-offset-blue-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden dark:border-zinc-700'>
                                        <div className='preview flex min-h-[450px] w-full p-4'>
                            ...
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>产品变体-03</h3>
                            <div className='relative z-0 flex items-center justify-between pb-4'>
                                <div className="relative min-h-screen w-full">
                                    <div className='focus-visible:ring-ring relative mt-2 rounded-md border border-zinc-200 ring-offset-blue-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden dark:border-zinc-700'>
                                        <div className='preview flex min-h-[450px] w-full p-4'>
                            ...
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>产品变体-04</h3>
                            <div className='relative z-0 flex items-center justify-between pb-4'>
                                <div className="relative min-h-screen w-full">
                                    <div className='focus-visible:ring-ring relative mt-2 rounded-md border border-zinc-200 ring-offset-blue-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden dark:border-zinc-700'>
                                        <div className='preview flex min-h-[450px] w-full p-4'>
                            ...
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>产品变体-05</h3>
                            <div className='relative z-0 flex items-center justify-between pb-4'>
                                <div className="relative min-h-screen w-full">
                                    <div className='focus-visible:ring-ring relative mt-2 rounded-md border border-zinc-200 ring-offset-blue-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden dark:border-zinc-700'>
                                        <div className='preview flex min-h-[450px] w-full p-4'>
