...
import QuantityInputBasic_ex_01 from "@/app/components/quantity_input/QuantityInputBasic_ex_01";
import QuantityInputBasic_ex_02 from "@/app/components/quantity_input/QuantityInputBasic_ex_02";
import QuantityInputBasic_ex_03 from "@/app/components/quantity_input/QuantityInputBasic_ex_03";
import Head from "@/app/Head";

export default function Quantity_Basic() {
    ...
    const items1: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <QuantityInputBasic_ex_01/>,
        },
        {
            key: '2',
            label: '代码',
    ...
    const items2: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <QuantityInputBasic_ex_02/>,
        },
        {
            key: '2',
            label: '代码',
    ...
    const items3: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <QuantityInputBasic_ex_03/>,
        },
        {
            key: '2',
            label: '代码',
            ...
            <div className='fixed inset-x-0 top-0 z-10 border-b border-gray-950/5 dark:border-white/10'>
                ...
                <div
                    ...
                    <ol className="sticky ml-4 flex min-w-0 items-center gap-2 text-sm/6 whitespace-nowrap">
                        <li className="flex items-center gap-2">数量
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div className='relative row-start-1 grid grid-cols-subgrid lg:col-start-3'>
                    <div className='mx-auto grid w-full max-w-2xl grid-cols-1 gap-2 xl:max-w-7xl xl:grid-cols-[minmax(0,1fr)_var(--container-2xs)]'>
                        <div className='flex flex-1 flex-col gap-6 px-4 pt-8 pb-24 sm:px-6 xl:pr-0'>
                            <h1 className='text-3xl font-semibold'>数量</h1>
                            <p className='mb-8 text-lg text-fd-muted-foreground'>数量 - 基础</p>
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>带有最小值和最大值验证的数量输入组件</h3>
                            ...
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>最小值，最大值</h3>
                            <h4 className='flex font-semibold scroll-m-28 flex-row items-center'>您可以为数量输入框设置一个范围max和一个min值。该组件不允许用户选择超出此范围的值。</h4>
                            <div className='relative z-0 flex items-center justify-between pb-4'>
                                <div className="relative min-h-screen w-full">
                                    <div className='focus-visible:ring-ring relative mt-2 rounded-md border border-zinc-200 ring-offset-blue-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden dark:border-zinc-700'>
                                        <div className='preview flex min-h-[450px] w-full p-4'>
                            ...
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>自定义</h3>
                            <h4 className='flex font-semibold scroll-m-28 flex-row items-center'>您可以为数量输入框设置一个值。该组件仅允许用户选择该值的倍数。</h4>
                            <div className='relative z-0 flex items-center justify-between pb-4'>
                                <div className="relative min-h-screen w-full">
                                    <div className='focus-visible:ring-ring relative mt-2 rounded-md border border-zinc-200 ring-offset-blue-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden dark:border-zinc-700'>
                                        <div className='preview flex min-h-[450px] w-full p-4'>
