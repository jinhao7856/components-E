...
import Upvote_Rating_Basic_Ex_01 from "@/app/components/upvote_rating/Upvote_Rating_Basic_Ex_01";
import Upvote_Rating_Basic_Ex_02 from "@/app/components/upvote_rating/Upvote_Rating_Basic_Ex_02";
    ...
    const items1: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <Upvote_Rating_Basic_Ex_01/>,
        },
        {
            key: '2',
            label: '代码',
    ...
    const items2: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <Upvote_Rating_Basic_Ex_02/>,
        },
        {
            key: '2',
            label: '代码',
                ...
                <div className='relative row-start-1 grid grid-cols-subgrid lg:col-start-3'>
                    <div
                        ...
                        <div className='flex flex-1 flex-col gap-6 px-4 pt-8 pb-24 sm:px-6 xl:pr-0'>
                            ...
                            <p className='mb-8 text-lg text-fd-muted-foreground'>评分-点赞-基础</p>
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>类似于Reddit的点赞和踩功能，可以进行评分</h3>
