...
import Variant_Color_Selector_Basic_Ex_01
    from "@/app/components/variant_color_selector/Variant_Color_Selector_Basic_Ex_01";
import Head from "@/app/Head";


export default function Variant_Color_Selector_Basic() {
    ...
    const items1: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <Variant_Color_Selector_Basic_Ex_01/>,
        },
        {
            key: '2',
            label: '代码',
            ...
            <div className='fixed inset-x-0 top-0 z-10 border-b border-gray-950/5 dark:border-white/10'>
                ...
                <div
                    ...
                    <ol className="sticky ml-4 flex min-w-0 items-center gap-2 text-sm/6 whitespace-nowrap">
                        <li className="flex items-center gap-2">颜色选择器
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div className='relative row-start-1 grid grid-cols-subgrid lg:col-start-3'>
                    <div
                        ...
                        <div className='flex flex-1 flex-col gap-6 px-4 pt-8 pb-24 sm:px-6 xl:pr-0'>
                            <h1 className='text-3xl font-semibold'>颜色选择器</h1>
                            <p className='mb-8 text-lg text-fd-muted-foreground'>颜色选择器-基础</p>
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>颜色选择器组件</h3>
