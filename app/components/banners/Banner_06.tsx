          ...
          <span className="mb-2 inline-block rounded-full bg-white/20 px-3 py-1 text-xs font-semibold text-white">
            赶快
                    ...
                    <p className="max-w-md text-white/80">
                        我们的特惠活动即将结束。所有高端产品均享七折优惠。倒计时结束前，抓紧时间！
                    </p>
                ...
                <div className="w-full md:w-auto">
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="mt-1 text-xs text-white/80">小时</div>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="mt-1 text-xs text-white/80">分</div>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="mt-1 text-xs text-white/80">秒</div>
                        </div>
                    </div>
                </div>
            </div>
