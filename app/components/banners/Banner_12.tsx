        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-950 to-zinc-900 px-6 py-6 shadow-2xl">
              ...
              <span className="inline-flex rounded-md bg-teal-400/20 px-3 py-1 text-sm font-bold text-teal-400">
                90天
                        ...
                        <p className="text-base font-medium text-slate-300">
                            购物{" "}
                            <span className="text-teal-400">无忧</span> — 无理由退货政策
                        </p>
                    </div>
                </div>
            ...
            >
                <div className="flex flex-col items-center text-center">
                    ...
                    <span className="text-sm font-bold text-white">90天可退</span>
                    <span className="text-xs text-slate-400">期限延长</span>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <span className="text-sm font-bold text-white">所有产品</span>
                    <span className="text-xs text-slate-400">全店铺范围</span>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <span className="text-sm font-bold text-white">全额退款</span>
                    <span className="text-xs text-slate-400">退款</span>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <span className="text-sm font-bold text-white">包邮</span>
                    <span className="text-xs text-slate-400">不额外收费</span>
                </div>
            </div>
        </div>
    );
