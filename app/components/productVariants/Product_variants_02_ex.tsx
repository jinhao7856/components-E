...
import ProductVariant_02, {VariantItem, VariantSelectionPayload} from "@/app/components/productVariants/Product_variants_02";
...
export default function ProductVariantExample_02() {
    ...
    return (
        <div className="container mx-auto p-4">
            <ProductVariant_02
                title="高级降噪耳机"
                description="体验我们优质无线耳机带来的水晶般清晰的音质。非常适合音乐爱好者、游戏玩家和专业人士."
                badge="新品"
                ...
                sellerName="Soundbeast工业"
                marketplaceName="XX市场"
                returnPolicyUrl="/"
            />
        </div>
    );
