...
import VariantSelectorBasic, {VariantItem as BaseVariantItem,} from "@/app/components/variant_selector/VariantSelectorBasic";
...
function Product_variant_01({
    ...
    if (errorMessage) {
        return (
            <div className="my-6 rounded-lg border border-red-200 bg-red-50 p-6 text-red-600 dark:border-red-900 dark:bg-red-900/20 dark:text-red-400">
                <p className="font-medium">加载产品失败</p>
    ...
    const variantsWithStockIndicator = variants.map((variant) => {
        ...
        return {
            ...
            label: variant.label + (isVariantInStock ? "" : " (已售罄)"),
        };
    });
...
export default Product_variant_01;
