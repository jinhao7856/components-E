...
import VariantSelectorBasic, {VariantItem} from "@/app/components/variant_selector/VariantSelectorBasic";

// Example model variants
const modelVariants: VariantItem[] = [
    { id: "model-light", label: "小号", value: "model-light" },
    { id: "model-medium", label: "中等", value: "model-medium" },
    { id: "model-large", label: "大号", value: "model-large" },
    { id: "model-ultra", label: "特大号", value: "model-ultra" },
];
