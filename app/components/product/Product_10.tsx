...
function ProductCard_10({
                            ...
                            currencyPrefix = "¥",
                            description = "这款超保湿护手霜蕴含乳木果油、芦荟和维生素E，能快速吸收，即刻缓解干燥肌肤，令双手柔软滋润，不油腻。非常适合日常使用，并能有效抵御恶劣天气带来的干燥.",
                            imageUrl = DEFAULT_IMAGE_URL,
                            ingredients = ["乳木果油", "芦荟", "维生素E", "荷荷巴油"],
                            newProduct = true,
                            onAddToCart = () => {},
                            onBuyNow = () => {},
                            onLearnMore = () => {},
