...
function ProductCard_06({
                            availableStock = 24,
                            currencyPrefix = "¥",
                            description = "新一代便携式扬声器，具备 360° 空间音频和 24 小时电池续航时间",
                            features = [
                                "360°沉浸式音效",
                                "防水设计",
                                "语音助手",
                            ...
                            price = 199.99,
                            productName = "无线扬声器",
                            releaseDate = "2024年8月15日",
                        }: ProductCard_06Props = {}) {
    const isLowStock = availableStock <= 25;

    return (
        <div className="group flex flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:shadow-md sm:h-[320px] sm:flex-row dark:border-gray-800 dark:bg-gray-900">
