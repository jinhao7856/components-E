...
function ProductCard_13({
                            ...
                            availableRooms = 5,
                            currencyPrefix = "¥",
                            description = "这家现代酒店拥有可欣赏城市美景的优雅客房、供应当地美食的餐厅以及可饱览全景的屋顶露台。酒店位于充满活力的市中心.",
                            distanceFromCenter = "距离市中心1.2Km",
                            featuredProperty = true,
                            hotelName = "格兰德阿祖尔酒店及水疗中心",
                  ...
                  {reviewCount} 评价
                    ...
                    <span className="text-sm font-medium text-blue-800 dark:text-blue-300">
                      限量优惠!
                        ...
                        这个价格只有 {roomsAtCurrentPrice} 个房间啦！
                      </span>
                                        </div>
                                    </div>
                                </div>
