...
function ProductCard_08({
                            currencyPrefix = "¥",
                            description = "这款平板电脑功能强大，拥有惊艳的显示屏、持久的电池续航时间和轻巧的设计",
                            ...
                            reviews = [
                                {
                                    name: "K.",
                                    rating: 5,
                                    text: "完美满足我的工作和娱乐需求。处理器速度很快！",
                                    verified: true,
                                },
                                {
                                    name: "L.",
                                    rating: 4,
                                    text: "很棒的设备，屏幕质量令人印象深刻.",
                                },
                                {
                                    name: "R.",
                                    rating: 5,
                                    text: "超强电池续航，轻松满足一整天的使用需求.",
                                    verified: true,
                                },
                            ],
                            stockCount = 24,
    ...
    return (
        <div className="flex flex-col overflow-hidden rounded-xl">
            ...
            <div className="group flex flex-col overflow-hidden rounded-xl border border-gray-200 bg-white transition-all duration-300 hover:shadow-md sm:h-[220px] sm:flex-row dark:border-gray-800 dark:bg-gray-900">
                ...
                {avgRating.toFixed(1)} ({reviews.length} 评论)
              </span>
                        </div>
                    </div>
