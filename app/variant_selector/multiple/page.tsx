...
import VariantSelector_Multiple_Ex_01 from "@/app/components/variant_selector/VariantSelector_Multiple_Ex_01";
import VariantSelector_Multiple_Ex_02 from "@/app/components/variant_selector/VariantSelector_Multiple_Ex_02";
import Head from "@/app/Head";


export default function VariantSelector_Multiple() {
    ...
    const items1: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <VariantSelector_Multiple_Ex_01/>,
        },
        {
            key: '2',
            label: '代码',
    ...
    const items2: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <VariantSelector_Multiple_Ex_02/>,
        },
        {
            key: '2',
            label: '代码',
                ...
                <div className='relative row-start-1 grid grid-cols-subgrid lg:col-start-3'>
                    <div
                        ...
                        <div className='flex flex-1 flex-col gap-6 px-4 pt-8 pb-24 sm:px-6 xl:pr-0'>
                            ...
                            <p className='mb-8 text-lg text-fd-muted-foreground'>选择器-多选</p>
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>具有多重选择的选择器组件</h3>
                            ...
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>多选布局</h3>
                            <div className='relative z-0 flex items-center justify-between pb-4'>
                                <div className="relative min-h-screen w-full">
                                    <div className='focus-visible:ring-ring relative mt-2 rounded-md border border-zinc-200 ring-offset-blue-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden dark:border-zinc-700'>
                                        <div className='preview flex min-h-[450px] w-full p-4'>
