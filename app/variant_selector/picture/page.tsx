...
import VariantSelector_Images_Ex_01 from "@/app/components/variant_selector/VariantSelector_Images_Ex_01";
import Head from "@/app/Head";


export default function Variant_Selector_Images() {
    ...
    const items1: TabsProps['items'] = [
        {
            key: '1',
            label: '预览',
            children: <VariantSelector_Images_Ex_01/>,
        },
        {
            key: '2',
            label: '代码',
                ...
                <div className='relative row-start-1 grid grid-cols-subgrid lg:col-start-3'>
                    <div
                        ...
                        <div className='flex flex-1 flex-col gap-6 px-4 pt-8 pb-24 sm:px-6 xl:pr-0'>
                            ...
                            <p className='mb-8 text-lg text-fd-muted-foreground'>选择器-图片</p>
                            <h3 className='flex font-semibold scroll-m-28 flex-row items-center'>带有图像的变体选择器组件</h3>
